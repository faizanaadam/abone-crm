...
for row in doctors_data:
    ...
    doc = {
        "koa_no": clean_val(row.get('Unnamed: 1')),
        "name": clean_val(row.get('Unnamed: 2')) or "Unknown",
        "specialization": clean_val(row.get('Unnamed: 3')),
        "role": clean_val(row.get('Unnamed: 4')),
        "phone": clean_val(row.get('Unnamed: 5')),
        "email": clean_val(row.get('Unnamed: 6')),
        "hospitals_practice": clean_val(row.get('Unnamed: 7')),
        "hospital_address": clean_val(row.get('Unnamed: 10')),
        "hospital_rating": clean_val(row.get('Unnamed: 11')),
        "hospital_reviews": clean_val(row.get('Unnamed: 12')),
        "hospital_category": clean_val(row.get('Unnamed: 13')),
        "hospital_website": clean_val(row.get('Unnamed: 14')),
        "hospital_maps_link": clean_val(row.get('Unnamed: 15')),
        "clinic_name": clean_val(row.get('Unnamed: 16')),
        "clinic_location": clean_val(row.get('Unnamed: 17')),
        "consultation_days": clean_val(row.get('Unnamed: 18')),
        "consultation_timing": clean_val(row.get('Unnamed: 19')),
        "approx_surgeries": clean_val(row.get('Unnamed: 20')),
        "pct_using_abone": clean_val(row.get('Unnamed: 21')),
        "full_address": clean_val(row.get('Unnamed: 22')),
        "ai_confidence": clean_val(row.get('Unnamed: 23')),
        "original_notes": clean_val(row.get('Unnamed: 24')),
        "source": clean_val(row.get('Unnamed: 25')),
        "lat": lat,
        "lon": lon,
        "location": location,
